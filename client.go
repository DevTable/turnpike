...
func NewWebsocketClient(serialization Serialization, url, proxyUrl string, tlscfg *tls.Config) (*Client, error) {
	p, err := NewWebsocketPeer(serialization, url, "", proxyUrl, tlscfg)
	if err != nil {
		return nil, err
	}
